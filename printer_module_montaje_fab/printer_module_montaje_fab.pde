...
void setup() {
  ...
  empty_ticket = loadImage("ticket-04.png");  // 05 para version sin marco
...
void draw() {
  ...
  String filepath = "/Users/arieluzal/Documents/Processing 3/estocolmo_2/repo/output/ticket" +   int(id_aux) + ".jpg";
